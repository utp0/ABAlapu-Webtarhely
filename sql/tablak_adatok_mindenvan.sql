...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_CSOPORTOK_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 ORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "KOMMENTEK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence UZENETEK_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "UZENETEK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into CSOPORTOK (ID,NEV,LEIRAS) values (21,'Első csoport ikszdé','mi vaguynk ez elsők');
Insert into CSOPORTOK (ID,NEV,LEIRAS) values (22,'Cicás képes csoport','macskákok');
Insert into CSOPORTOK (ID,NEV,LEIRAS) values (23,'Csoportkereső csoport','név');
...
SET DEFINE OFF;
Insert into FAJLHOZ (ID_FAJL,ID_KOMMENT) values (3,21);
Insert into FAJLHOZ (ID_FAJL,ID_KOMMENT) values (4,22);
...
SET DEFINE OFF;
Insert into IRTA (NEV_FELHASZNALO,ID_KOMMENT) values ('exampleuser5',21);
Insert into IRTA (NEV_FELHASZNALO,ID_KOMMENT) values ('exampleuser6',22);
REM INSERTING into KAPTAFELADTA
SET DEFINE OFF;
Insert into KAPTAFELADTA (NEV_KULDO,NEV_FOGADO,ID_UZENET) values ('exampleuser1','exampleuser2',1);
Insert into KAPTAFELADTA (NEV_KULDO,NEV_FOGADO,ID_UZENET) values ('exampleuser2','exampleuser1',2);
REM INSERTING into KOMMENTEK
SET DEFINE OFF;
Insert into KOMMENTEK (ID,SZOVEG) values (21,'ez nagyon tecik');
Insert into KOMMENTEK (ID,SZOVEG) values (22,'ez nem tetszik');
...
SET DEFINE OFF;
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser1',21);
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser2',21);
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser3',21);
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser4',22);
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser5',22);
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser6',22);
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser7',23);
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser8',23);
Insert into TAGJA (NEV_FELHASZNALO,ID_CSOPORT) values ('exampleuser9',23);
REM INSERTING into UZENETEK
SET DEFINE OFF;
Insert into UZENETEK (ID,SZOVEG) values (1,'Na, holnap akkor lorem ipsum?');
Insert into UZENETEK (ID,SZOVEG) values (2,'benne vagyok, mehet');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "FAJLHOZ" ADD CONSTRAINT "FAJL_KOMMENT_FK2" FOREIGN KEY ("ID_KOMMENT")
